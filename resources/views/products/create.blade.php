        ...
        <div class="py-16 px-16 mx-auto max-w-screen-md sm:py-16 lg:px-16 ">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full mt mb-2">
                    <x-input-field label="Nama Produk" name="name" id="name" placeholder="Masukkan nama produk" value="{{ old('name', $product->name ?? '') }}" />
                    <x-error-message field="name" />
                </div>
                <div class="w-full mt-2 mb-2">

                    <x-input-field type="number" label="Harga" name="price" id="price" placeholder="Masukkan harga produk" value="{{ old('price', $photo->price ?? '') }}" />
                ...
                <div class="sm:col-span-2 mt-2 mb-2">
                    ...
                    <x-textarea-editor id="description" name="description" label="Deskripsi Produk" value="
