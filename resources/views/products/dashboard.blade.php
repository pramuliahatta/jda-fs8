        ...
        <div class="px-4 mx-auto max-w-screen-2xl lg:px-12">
            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div
                    ...
                    {{-- add product button --}}
                    <div
                        class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-end lg:justify-end md:space-y-0 md:space-x-3">
                        <a href="{{ route('products.create') }}"
                            class="flex items-center justify-end px-4 py-2 text-sm font-medium text-white rounded-lg bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-center"><span class="sr-only">Actions</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data as $index => $product)
                                <tr class=" border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="px-4 py-2">
                                        <span
                                            class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 ">{{ $index + 1 }}</span>
                                    </td>
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <button type="button" data-modal-target="deleteModal"
                                                        data-modal-toggle="deleteModal" data-id="{{ $product['id'] }}"
