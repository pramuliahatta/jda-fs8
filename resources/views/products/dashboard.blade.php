                ...
                <form id="productForm" action="{{ route('products.index') }}" method="get">
                    <div
                        ...
                        <div
                            ...
                            <div id="filterDropdown" class="hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700"
                                style="z-index: 1000">
                            ...
                            <div
                                ...
                                <div class="w-full md:w-full">
                                    ...
                                    @if (request('search') || request('categories'))
                                        <a href="{{ route('products.index') }}" type="button" id="resetButton"
...
<script>
    document.querySelectorAll('.delete-button').forEach(button => {
        button.addEventListener('click', () => {
            ...
            document.getElementById('delete-form').setAttribute('action', `/seller/products/${itemId}`);
        })
    })
