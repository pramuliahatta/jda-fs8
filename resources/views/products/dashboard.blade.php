<x-layout>
    <x-slot name="title">Pasar Desa</x-slot><section class="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                    ...
                    <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-end lg:justify-end md:space-y-0 md:space-x-3">
                        <button type="button" class="flex items-center justify-end px-4 py-2 text-sm font-medium text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                {{-- <th scope="col" class="px-4 py-3 text-center">ID Produk</th> --}}
                        ...
                        <tbody>
                            <tr class=" border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                {{-- <td class="px-4 py-2">
                                    <span class="bg-primary-100 text-primary-800 text-xs text-center font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 ">1</span>
                                </td> --}}
