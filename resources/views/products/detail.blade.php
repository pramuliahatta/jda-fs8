                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-6 flex space-x-4">
                      <a href="#" onclick="changeImage('https://via.placeholder.com/300')">
                        <img src="https://via.placeholder.com/100" alt="Thumbnail 1" class="thumbnail w-16 h-16 object-cover border-2 border-gray-300">
                    </a>
                    <a href="#" onclick="changeImage('https://via.placeholder.com/300/FF0000/FFFFFF')">
                        <img src="https://via.placeholder.com/100/FF0000/FFFFFF" alt="Thumbnail 2" class="thumbnail w-16 h-16 object-cover border-2 border-gray-300">
                    </a>
                    <a href="#" onclick="changeImage('https://via.placeholder.com/300/00FF00/FFFFFF')">
                        <img src="https://via.placeholder.com/100/00FF00/FFFFFF" alt="Thumbnail 3" class="thumbnail w-16 h-16 object-cover border-2 border-gray-300">
                    </a>
