            ...
            <form action="{{ route('products.update', $data['id']) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full mt-2 mb-2">
                    <x-input-field type="number" label="Harga" name="price" id="price"
                        placeholder="Masukkan harga produk (contoh: Rp 10.000)" value="{{ $data['price'] }}" />
                ...
                <div>
                    ...
                    <select name="category" id="category"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <option value="Kerajinan" {{ $data['category'] == 'Kerajinan' ? 'selected' : '' }}>Kerajinan
                        </option>
