                ...
                <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
                  <div class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div>
                      ...
                      {{-- product name --}}
                      <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">JANGKRIK”</a>
                      
                      {{-- description products --}}
                      <p class="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">Jamu yang terbuat dari 100% bahan organik</p>
                    </div>
                    <div>
                      {{-- discount price
