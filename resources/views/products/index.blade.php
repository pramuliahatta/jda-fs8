                        ...
                        <div class="flex items-center w-full space-x-3 md:w-auto">
                            ...
                            <form method="GET" action="{{ route('products') }}">
                                ...
                                <div id="filterDropdown"
                                    ...
                                    <button type="submit"
                                        class="inline-flex items-center px-2 py-1 mt-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-500 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        Filter</button>
                                </div>
                            </form>
                        </div>
