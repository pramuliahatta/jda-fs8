                    ...
                    <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-base font-normal text-gray-700 dark:text-gray-400">{{ strlen($product['description']) > 100 ? substr($product['description'], 0, 100) . '...' : $product['description'] }}</p>
                            </div>
                            <div>

                                {{-- real price --}}
                                <p class="text-lg font-bold leading-tight text-red-600 dark:text-red-500">{{ 'Rp. ' . number_format($product['price'], 0, ',', '.') }}</p>
                            </div>
