                    ...
                    <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">{{ strlen($product['description']) > 100 ? substr($product['description'], 0, 100) . '...' : $product['description'] }}</p>
                            </div>
                            <div>
                                {{-- discount price
