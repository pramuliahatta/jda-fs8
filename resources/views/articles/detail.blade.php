        ...
        <div class="px-4 mx-auto max-w-screen-xl">
            ...
            <div class="grid gap-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <article class="max-w-xs">
                    <a href="#">
                        <img class="mb-5 h-44 w-full object-cover rounded-lg" src="/{{ $article['photo'] }}" alt="{{ $article['title'] }}">
                    </a>
                    ...
                    <a href="{{ route('articles.detail', $article['id']) }}" class="inline-flex items-center font-medium underline underline-offset-4 text-green-500 dark:text-primary-500 hover:no-underline">
                        Baca Selengkapnya
                    </a>
                </article>
                @endif
