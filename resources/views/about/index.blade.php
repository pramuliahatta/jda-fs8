                ...
                <div class="bg-white-200 text-grey  rounded-lg  flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div class="md:w-2/3">
                      ...
                      <div class="md:w-1/3 mt-4 md:mt-0 md:ml-6 mx-auto h-full w-full dark:hidden rounded-lg object-cover">
                        <img src="https://png.pngtree.com/png-clipart/20221020/original/pngtree-kepala-daerah-png-image_8708543.png" alt="Foto Kepala Desa" class="rounded-lg shadow-lg w-full h-auto object-cover">
                      </div>
                    </div>
            </div>
        </section>
            ...
            <div class="container mx-auto">
                <div class="bg-white-200 text-grey  rounded-lg  flex flex-col md:flex-row items-center md:items-start">
                    <div class="md:w-1/2 mt-4 md:mt-0 md:ml-6 mx-auto dark:hidden rounded-lg object-cover">
                        <img 
                        class="mx-auto h-70 w-50 dark:hidden rounded-lg object-cover"
                        src="https://imgur.com/MB1tTu7" 
                        alt="Foto peta desa" >
                    </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                <div class="mx-auto mb-6 max-w-screen-sm lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Struktur Organisasi</h2>
