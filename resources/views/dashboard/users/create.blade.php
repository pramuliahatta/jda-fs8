                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    <input type="number" id="phone_number" name="phone_number_display"
                    ...
                    <div>
                        <x-input-field type="password" label="Kata Sandi" name="password" id="password"
                            placeholder="Masukkan kata sandi" value="{{ old('password', $data['password'] ?? '') }}" />
...
<script>
    document.getElementById('user-form').addEventListener('submit', function(event) {
        ...
        hiddenPhoneInput.value = '62' + phoneInput.value;
