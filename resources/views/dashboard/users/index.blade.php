    ...
    <x-dashboard-section route='dashboard.users.index'>
        ...
        <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0"
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                    <li>
                        <a href="{{ $data['prev_page_url'] == null? '#' : str_replace(env('BASE_URL_API') . "users", url()->current(), $data['prev_page_url']) }}"
                    ...
                    <li>
                        <a href="{{ $link['url'] == null? '#' : str_replace(env('BASE_URL_API') . "users", url()->current(), $link['url']) }}" aria-current="page"
                    ...
                    <li>
                        <a href="{{ $data['next_page_url'] == null? '#' : str_replace(env('BASE_URL_API') . "users", url()->current(), $data['next_page_url']) }}"
