    ...
    <x-dashboard-section route='dashboard.articles.index'>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full md:w-1/2">
                <form class="flex items-center" action="{{ route('dashboard.articles.index') }}" method="get">
                        ...
                        <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <input id="sort-desc" type="radio" value="desc" name="sort"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="sort-desc"
                                        class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Terbaru</label>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <input checked="" id="sort-asc" type="radio" value="asc"
                                        name="sort"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="sort-asc"
                                        class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Terlama</label>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <tbody>
                    @foreach ($data as $index => $item)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 max-w-[12rem] truncate">{{ $item['body'] }}</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="{{ $item['id'] }}-dropdown"
                                    ...
                                    <ul class="py-1 text-sm" aria-labelledby="{{ $item['id'] }}-dropdown-button">
                                        <li>
                                            <a href="{{ route('dashboard.articles.edit', $item['id']) }}"
                                        ...
                                        <li>
                                            <button type="button" data-modal-target="deleteModal"
                                                ...
                                                class="flex delete-button w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
