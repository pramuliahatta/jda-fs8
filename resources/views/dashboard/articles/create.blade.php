        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Artikel</h3>
                </div>
                <!-- Modal body -->
                <form action="#">
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        ...
                        <div>
                            <label for=""
                                class="block w-full mb-2 text-sm font-medium text-gray-900 dark:text-white">Artikel</label>
                            <div
                                ...
                                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea id="editor" rows="8"
                                        ...
                                        placeholder="Tulis artikel..." required></textarea>
                                </div>
                            </div>
                        </div>
