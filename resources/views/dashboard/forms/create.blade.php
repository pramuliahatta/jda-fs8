        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah File</h3>
                </div>
                <!-- Modal body -->
                <form action="#">
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        <div>
                            <label for="title"
                                class="block w-full mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Formulir</label>
                        ...
                        <div>
                            <label for="title"
                                class="block w-full mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan</label>
                            <input type="text" name="title" id="title"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="" required="">
                        </div>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="photo"
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">PDF (MAKS.
                                            2MB)</p>
                                    </div>
