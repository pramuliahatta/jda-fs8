...
<article class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex justify-between items-center mb-2 text-gray-700">
        <span class="{{ $categoryClass }} text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
    ...
    <div class="flex justify-between items-center">
        <div class="hidden md:flex items-center space-x-4">
            <img class="w-7 h-7 bg-green-400 rounded-full" src="{{ asset('img/static/Lambang_Kabupaten_Majalengka.svg') }}" alt="profile-photo" />
            <span class="font-medium dark:text-white">Admin</span>
        </div>
        <a href="{{ route('articles.detail', $article['id']) }}" class="inline-flex items-center font-medium text-green-400 dark:text-primary-500 hover:underline">
            Baca Selengkapnya
