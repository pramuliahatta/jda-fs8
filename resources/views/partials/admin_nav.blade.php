<nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" class="flex mx-3 text-sm bg-green-200 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl" id="dropdown">
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <a href="{{ route('home') }}" class="w-full text-left block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            Home
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dashboard.users.edit', Auth::user()->id) }}" class="w-full text-left block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            Ubah Profil
                        </a>
                    </li>
                    <li>
...
<aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidenav" id="drawer-navigation">
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            ...
            <svg class="w-6 h-6 dark:text-white {{ request()->routeIs('dashboard.index') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <x-sidebar-link href="{{ route('dashboard.articles.index') }}" :active="request()->routeIs('dashboard.articles.*')">
                <svg class="w-6 h-6 dark:text-white {{ request()->routeIs('dashboard.articles.*') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <x-sidebar-link href="{{ route('dashboard.gallery.index') }}" :active="request()->routeIs('dashboard.gallery.*')">
                <svg class="w-6 h-6 dark:text-white {{ request()->routeIs('dashboard.gallery.*') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <x-sidebar-link href="{{ route('dashboard.forms.index') }}" :active="request()->routeIs('dashboard.forms.*')">
                <svg class="w-6 h-6 dark:text-white {{ request()->routeIs('dashboard.forms.*') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <x-sidebar-link href="{{ route('dashboard.products.index') }}" :active="request()->routeIs('dashboard.products.*')">
                <svg class="w-6 h-6 dark:text-white  {{ request()->routeIs('dashboard.products.*') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <x-sidebar-link href="{{ route('dashboard.users.index') }}" :active="request()->routeIs('dashboard.users.*')">
                <svg class="w-6 h-6 dark:text-white {{ request()->routeIs('dashboard.users.*') ? 'text-green-500' : 'text-gray-800 dark:text-white' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
