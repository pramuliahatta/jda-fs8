{{-- <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 relative">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center hidden sm:block text-xs font-semibold whitespace-nowrap dark:text-white">
        ...
        <div class="hidden w-full" id="navbar-hamburger">
            <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                ...
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-blue-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        Log in
                    </a>
                </li>
            </ul>
